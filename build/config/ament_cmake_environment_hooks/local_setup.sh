...
: ${AMENT_CURRENT_PREFIX:="/home/doughnut/code/BamthrivingVision_ROS_framework/install/config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/config/environment/path.sh"
